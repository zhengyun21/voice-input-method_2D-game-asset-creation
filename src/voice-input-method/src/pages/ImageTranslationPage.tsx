...
export const ImageTranslationPage = () => {
  ...
  const handleTargetChange = useCallback(
    (lang: Language) => {
      ...
      if (translation && recognizedText.trim() && recognizedText.trim() !== "未检测到文字") {
        autoTranslate(recognizedText, lang);
      }
    },
    [recognizedText, translation, autoTranslate],
  );
        ...
        {recognizedText && !isRecognizing && (
          <>
            ...
            <button
              ...
              disabled={isTranslating || !recognizedText.trim() || recognizedText.trim() === "未检测到文字"}
